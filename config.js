...
//TIME
global.waktu = `${date}`
global.namabot = '⫹⫺𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂'
global.v = '-'   
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
// Sticker WM
global.packname = `☂︎ 𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂`
...
//--------[WATERMARK]
global.wm = '𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂' //Main WM
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘バージニティハンター˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂'
global.md = '𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂‌'
//-----[OWNER]
...
['51902679067', '𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂🦄', 'true'] // global owner 3
]
global.mods = [] // Want some help?
global.prems = ['51902679067'] // Premium user has unlimited limit

// =================={[(API KEYS)]}==================
global.mupar = '𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂'
global.org = '4SVXAlaZC9Ix9LK5O33M7qeZ'
global.openai = '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' // ISI APIKEY OPENAI LU 🥵
global.APIs = {
...
global.APIKeys = {
'https://pnggilajacn.my.id': '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',      // ISI APIKEY OPENAI LU 🥵
'https://xzn.wtf': '_',     // https://wa.me/6289523302916 🙂
'https://api.xteam.xyz': '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',    // ISI APIKEY OPENAI LU 🥵
'https://zenzapis.xyz': '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',    // ISI APIKEY OPENAI LU 🥵
'https://api-fgmods.ddns.net': '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',    // ISI APIKEY OPENAI LU 🥵
'https://zenzapi.xyz': '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',    // ISI APIKEY OPENAI LU 🥵
'https://violetics.pw': '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',   // ISI APIKEY OPENAI LU 🥵
'https://api.lolhuman.xyz': '3f60a8f5be1b233d7bd90c3c',   // https://wa.me/6289523302916LU 🙂
'https://xzn.wtf/': '_'      // https://wa.me/6289523302916 🙂
}
global.lolkey = '3f60a8f5be1b233d7bd90c3c'    // https://wa.me/6289523302916 🙂
global.lolkeysapi = [ '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' ]     // ISI APIKEY OPENAI LU 🥵
global.lol = '3f60a8f5be1b233d7bd90c3c'      // https://wa.me/6289523302916 🙂
global.rose = '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'  // ISI APIKEY OPENAI LU 🥵
global.xyro = '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'  // ISI APIKEY OPENAI LU 🥵
...
global.footer = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ ฅ˘𝚂𝚈𝚂𝚂𝙾𝙻𝚄𝚃𝙸𝙾𝙽𝚂˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
/*============== SOCIAL ==============*/
global.sig = 'https://instagram.com/SysSolutions.peru' //Link Instagrammu
